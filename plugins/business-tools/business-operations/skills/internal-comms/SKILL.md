---
name: internal-comms
description: Use when a Head of People Ops, BizOps lead, or Internal Communications owner needs to draft and sequence an internal-only change-management communication — a re-org announcement, tool rollout, policy change, leadership transition, layoff, acquisition close, or internal product launch — for an employee audience (not customers). Trigger with phrases like "all-hands announcement", "town-hall script", "change comms", "rollout comms", "re-org announcement", "internal FAQ", "manager talking points", "Prosci ADKAR", "Kotter 8-step", or "layoff comms". Pairs Prosci ADKAR and Kotter's 8-step change model with deterministic stdlib-only Python tools to produce a sequenced touchpoint calendar, a Kotter-compliant primary announcement, an audience-segmented FAQ, and manager cascade talking points. Industry-tuned via --profile {tech-startup, scaleup, enterprise, public-company, non-profit}. Distinct from external/customer-facing marketing and strategic executive change-management.
