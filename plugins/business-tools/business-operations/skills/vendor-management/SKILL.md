...
description: Use when reviewing, scoring, or auditing third-party SaaS / vendor relationships — running a vendor scorecard, tracking SLA compliance, classifying third-party risk, preparing a tier-1 vendor review, or auditing the SaaS portfolio. Trigger with phrases like "vendor SLA", "vendor scorecard", "third-party risk", "TPRM", "vendor review", "SaaS audit", "supplier performance", or "renewal review". Ships 3 stdlib-only Python tools (vendor scorer with industry tuning, SLA compliance tracker with credit-claim flags, vendor risk classifier across 4 risk vectors), reference docs citing authoritative sources (Gartner / Shared Assessments / NIST / ISO 27036), and a vendor catalog template. Distinct from contract-law advisory (operational, not legal) and procurement-optimizer (spend categorization, not vendor performance).
context: fork
